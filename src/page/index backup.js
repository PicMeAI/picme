  ...
  if(this.state.progress===1){if(!this.state.peeps1){
    return (
      ...
      <div className="backbroad" >
        ...
        <div className='text5' >Generate your portrait</div>
        <div className='text6' >Embellish your portrait</div>
        <div className='text7' >Preview your portrait</div>
        <div className='page'>
        <div>
        ...
        <div>
        <div style={{/* Select a scenario */position: 'absolute',width: '490px',height: '71px',left: '776px',top: '189px',fontFamily: 'Poppins',fontStyle: 'normal',fontWeight: '500',fontSize: '32px',lineHeight: '48px',color: '#595566'
  }}>Check your portrait</div>
    ...
    if(this.state.portrait && this.state.scenario1 && this.state.scenario2){
      return (
        <div><div className="backbroad" >
          ...
          <div className='text6' >Embellish your portrait</div>
          <div className='text7' >Preview your portrait</div>
          <div style={{/* Select a scenario */position: 'absolute',width: '490px',height: '71px',left: '268px',top: '181px',fontFamily: 'Poppins',fontStyle: 'normal',fontWeight: '500',fontSize: '32px',lineHeight: '48px',color: '#595566'
  }}>Select a scenario</div>
  <div style={{/* Select a scenario */position: 'absolute',width: '287px',height: '48px',left: '1007px',top: '181px',fontFamily: 'Poppins',fontStyle: 'normal',fontWeight: '500',fontSize: '32px',lineHeight: '48px',color: '#595566',opacity:0
...
<div style={{/* Select a scenario */position: 'absolute',width: '287px',height: '48px',left: '1207px',top: '181px',fontFamily: 'Poppins',fontStyle: 'normal',fontWeight: '500',fontSize: '32px',lineHeight: '48px',color: '#595566'
}}>Select a portrait</div>
      ...
      if(this.state.style){
        return (<div>
          <div className="backbroad" >
            ...
            <div className='text7' >Preview your portrait</div>
            <div className='page'>
            <div style={{/* Select a scenario */position: 'absolute',width: '360px',height: '71px',left: '647px',top: '177px',fontFamily: 'Poppins',fontStyle: 'normal',fontWeight: '500',fontSize: '32px',lineHeight: '48px',color: '#595566'
    }}>Select a style</div>
    ...
    .then((blob) => {
      ...
      return (<div>
        <div className="backbroad" >
          ...
          <div className='text7' >Preview your portrait</div>
          <div className='page'>
          <div style={{/* Select a scenario */position: 'absolute',width: '360px',height: '71px',left: '740px',top: '188px',fontFamily: 'Poppins',fontStyle: 'normal',fontWeight: '500',fontSize: '32px',lineHeight: '48px',color: '#595566'
  }}>Select a style</div>
